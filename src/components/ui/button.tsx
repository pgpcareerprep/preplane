...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-control text-sm font-medium ring-offset-background transition-all duration-150 ease-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-8 px-3.5 text-[13px] rounded-control",
        default: "h-9 px-[18px] py-2 text-sm rounded-control",
        lg: "h-11 px-6 text-base rounded-control",
        xl: "h-12 px-7 text-[17px] rounded-control",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
