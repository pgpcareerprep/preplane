...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-[rgba(26,25,22,0.7)] lumina-backdrop data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 grid w-full gap-4 border border-border bg-card p-6 shadow-xl duration-200",
        /* Mobile: bottom sheet */
        ...
        "md:left-[50%] md:top-[50%] md:w-[calc(100%-2rem)] md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-modal",
