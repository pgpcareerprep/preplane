-- Stable mentor identity resolution and transactional mentor/session assignment.
...
BEGIN
  ...
  VALUES (
    p_lmp_id, v_mentor_id, p_mentor->>'name', p_mentor->>'source',
    p_match_score, 'assigned', 'mentor_assignment_rpc', now()
  )
  ...
  SET mentor_selected = p_mentor->>'name', mentor_aligned = true
  WHERE id = p_lmp_id;
